...
import com.tuflex.admin.handler.CustomLoginSuccessHandler;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .and()
                .formLogin(login -> login.loginPage("/user/loginView")
                        .successForwardUrl("/index")
                        .failureForwardUrl("/user/loginView?error")
    ...
    public CustomAuthenticationFilter customAuthenticationFilter() throws Exception {
        ...
        customAuthenticationFilter.setAuthenticationFailureHandler(
                new SimpleUrlAuthenticationFailureHandler("/user/loginView?error"));
